...
const preservedConcepts = [
  ...
  { label: 'bug reproduction before editing', needle: 'Reproduce the defect' },
  { label: 'shared-cause bug correction', needle: 'Fix the shared cause' },
  { label: 'dependency use evidence', needle: 'installation from active product use' },
